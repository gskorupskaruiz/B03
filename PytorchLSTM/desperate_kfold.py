...
testing_hyperparameters =  [0.00167, 8, 2000, 5, [1, 9, 18, 27, 36], [1, 5, 2.0, 7.0, 9.0], [1, 1, 1, 1, 1], [1, 1, 2, 3, 4], 14, 3, [24, 18, 12, 6, 1]] # best kfold
run_model_cv(testing_hyperparameters, 'hybrid', 4, save_for_plots = True)