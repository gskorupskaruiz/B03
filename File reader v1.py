# Heavenly inspired by Branden Ciranni <branden.ciranni@gmail.com>
...
def read_nasa(i):
    ...
    file_path = f'data\{battery_name}.mat'
...
if __name__ == '__main__':
    df = read_nasa(32)
    # df.to_csv('data\B0029.csv', index=False)
    # df.to_csv('data\B0030.csv', index=False)
    # df.to_csv('data\B0031.csv', index=False)
    df.to_csv('data\B0032.csv', index=False)
